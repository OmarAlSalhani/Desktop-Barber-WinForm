...
namespace barber_app.classes
{
    class my_grid_view_class
    {
            ...
            gridview.CustomDrawEmptyForeground += (s, e) =>
              {
                  ...
                  font = new Font("cairo", 10, System.Drawing.FontStyle.Bold);
        ...
        public static void set_find_panel_font2(DevExpress.XtraGrid.Views.Grid.GridView gridView, DevExpress.XtraGrid.GridControl gridControl, bool show_footer, bool show_find_panel, bool allow_color_edit = true)
        {
            ...
            gridView.Appearance.FooterPanel.Font = new Font("cairo", 9);
            gridView.Appearance.FocusedRow.Font = new Font("cairo", 9);
            gridView.Appearance.SelectedRow.Font = new Font("cairo", 9);
            gridView.Appearance.Row.Font = new Font("cairo", 9);
            gridView.Appearance.HotTrackedRow.Font = new Font("cairo", 9);
            gridView.Appearance.HeaderPanel.Font = new Font("cairo", 9);
            ...
            gridControl.Layout += (s, e) =>
            {
                if (gridView.IsFindPanelVisible)
                {
                    ...
                    if (findPanel != null)
                    {
                        ...
                        findPanel.FindEdit.Font = new Font("cairo", 9);
                        findPanel.FindButton.Appearance.Font = new Font("cairo", 9);
                    }
                }
            };
            if (allow_color_edit)
        ...
        public static void set_font_and_hover_effect(DevExpress.XtraGrid.Views.Grid.GridView main_gridview, int header_font_size = 10, int row_font_size = 9)
        {
            Font body_font;
            Font head_font;
            body_font = new Font("cairo", row_font_size);
            head_font = new Font("cairo", header_font_size, FontStyle.Bold);
