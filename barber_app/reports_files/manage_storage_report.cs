using System.Windows.Forms;using DevExpress.XtraReports.UI;using System;using barber_app.classes;

namespace barber_app.repost_pos
{
    public partial class manage_storage_report : DevExpress.XtraReports.UI.XtraReport
    {
        public manage_storage_report()
        {
            InitializeComponent();
        }
        public static void to_pdf(System.Data.DataTable products_datasource)
        {
            ...
            manage_storage_report report = new manage_storage_report();
