...
{
    public partial class customers_paied_money_report : DevExpress.XtraReports.UI.XtraReport
    {
        public customers_paied_money_report()
        {
            InitializeComponent();
        }
        public static void to_pdf(System.Data.DataTable products_datasource)
        {
            ...
            customers_paied_money_report report = new customers_paied_money_report();
