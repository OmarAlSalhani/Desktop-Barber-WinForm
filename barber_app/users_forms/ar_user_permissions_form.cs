...
namespace barber_app.users_forms
{
    public partial class ar_user_permissions_form : DevExpress.XtraEditors.XtraForm
    {
        ...
        void get_roles()
        {
            ...
            manage_products.Checked = table_cell_to_int(table.Rows[0]["manage_products"].ToString());
            manage_categories.Checked = table_cell_to_int(table.Rows[0]["manage_categories"].ToString());
...
manage_products={checkbox_to_int(manage_products)},
manage_categories={checkbox_to_int(manage_categories)},
